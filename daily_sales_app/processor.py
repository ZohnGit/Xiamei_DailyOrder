...
def process_daily_sales(
    ...
    for platform_config in platform_configs:
        ...
        rows = read_table(platform_files[platform_name])
        ...
        for row in rows:
            ...
            final_operator = matched_operator or operator_name
...
def write_report(
    ...
    for config in platform_configs:
        operator = clean_text(config["operator"])
        if operator and operator not in seen_operators:
